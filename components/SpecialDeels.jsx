      ...
      <div className="text-white flex flex-col py-7 gap-2 mx-auto text-center container px-7">
        ...
        {timeLeft.length !== 0 ? (
          <div className="flex items-center gap-6  justify-center py-3">
            {timeLeft.map((time, i) => (
              <div key={i} className="flex flex-col bg-white/20 p-3">
                <h3 className="font-extrabold text-4xl">{time}</h3>
        ...
        <Link href="/products" className="btn bg-white w-fit mx-auto mt-3">
